...
export default class Tabs extends React.Component {
  ...
  renderItem = (item) => {
    ...
    const textColor = this.animatedValue.interpolate({
      inputRange: [0, 1],
      outputRange: [seekTheme.COLORS.BLACK, isActive ? seekTheme.COLORS.WHITE : seekTheme.COLORS.BLACK],
      extrapolate: 'clamp',
    });
    
    const containerStyles = [
      styles.titleContainer,
      !isActive && { backgroundColor: seekTheme.COLORS.SECONDARY },
